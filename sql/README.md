...
| `CC_AND_CUST_TABLE_CREATION.sql` | 
Creates the `CCDB` MySQL database with two tables: `cc_detail` (card/transaction data) 

and `cust_detail` (customer demographic data), matching the file structure in [`/data`] |
